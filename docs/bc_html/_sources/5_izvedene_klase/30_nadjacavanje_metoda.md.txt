...
Појам "надјачавање метода" (енгл. *Method Overriding*) односи се на могућност
надјачавања или преовладавања метода базне класе у изведеним класама. Тиме се
омогућава да се у изведеним класама дефинишу специфичне имплементације метода
...
Такође, објекат типа базне класе може да референцира објекат изведене класе. На
пример:
...
Иако изгледа прилично једноставно, могућност надјачавања метода базне класе у
