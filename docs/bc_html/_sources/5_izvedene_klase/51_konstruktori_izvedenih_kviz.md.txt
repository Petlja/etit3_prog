...
```{mchoice}
:answer1: Доћи ће до грешке јер у базној класи није експлицитно позван јавни подразумевани конструктор класе `System.Object`.
:answer2: Доћи ће до грешке јер у изведеној класи није експлицитно позван јавни подразумевани конструктор базне класе.
:answer3: Неће доћи до грешке јер ће компајлер сâм допунити кôд конструктора у изведеној класи кључном речју `base`.
