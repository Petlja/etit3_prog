...
једноставно. Кликом на дугме `btnDodaj` потребно је унето име из оквира за
...
Једна од основних функција прилико рада са било каквим листама је свакако
претрага листе. У оквиру за листу можеш да користиш методу `FindString()`
као би пронашао стринг или субстринг на листи и означио резултат:
...
које одговара задатом стрингу. Ако не постоји полазник на листи које одговара
...
начин за уклањање ставски са листе у овом случају је методом `RemoveAt()`:
...
Ако корисник није означио полазника и кликнуо на дугме `btnObrisi` добиће
поруку о томе:
