...
процедуралне (komentar: posto postoji objasnjenje sta znaci imperativna paradigma, mozda dodati i sta znaci da je jezik proceduralnog tipa) програмске парадигме. У императивној програмској парадигми користе
...
атрибути (подаци) и методе (акције).  (Komentar: super je ovaj prethodni deo kojim se intuitivno objasnjanja potreba za klasifikacijom, samo bih negde na pocetku odmah rekla da se cela ova prica odnosi na svojstvo jezika da je objektno-orijentisan)
...
## Кратак историјат развоја ООП (komentar: negde ranije uvesti skracenicu OOP)
