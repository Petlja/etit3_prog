...
схватити као скицу, нацрт или шаблон на основу које се инстанцирају (појављују, дефинишу) објекти. (komentar: termin pojavljuju mi nekako ne zvuci adekvatno)
...
$c=5.0$. (komentar: mozda reci "cije su stranice redom duzina") То значи и да си за `t1` алоцирао простор у статичкој меморији (на
