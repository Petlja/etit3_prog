...
`Dokvalifikacija` и по тој грани у хијерахији наслеђивања ту мора бити крај. Не
...
Члан у изведеној класи (метода, идексер, својство или догађај) који
преоптерећује виртуелног члана базне класе може се прогласити запечаћеним.

На пример, ако желиш да спречим да се мења функционалност надјачане методе
...
интегритета и сигурности кода, као и да оптимизацији перформанси.
