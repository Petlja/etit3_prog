...
Кликни на прво дугме и креирај догађај миша `Click`, па исто ро уради и са
...
Својствa које требаш прво подесити су својство `Name` и својство `Location`
којим се одређује локација динамички креиране контроле на форми у односу на
горњи леви угао форме одређена *(X, Y)* координатама. Након тога можеш
...
Динамичке компоненте се могу уклонити на више начина. Први и најједноставнији
