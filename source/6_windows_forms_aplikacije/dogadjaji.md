...
**Делегати** су типови који представљају референце на методе. Они се користе за
чување и позивање метода, чиме се омогућава реализација догађаја и повратних
позива (енгл. *callback*) у програму. Делегати су веома корисни у ситуацијама
када желиш да пренесеш метод као аргумент некој другој методи или да је
обавестиш о догађајима. Делегати су типизирани, што значи да могу позивати само
методе који одговарају њиховом потпису. Делегат се инстанцира да упути на
конкретну методу, а потом се та метода може позвати путем делегата. Притом,
делегати могу позивати више метода одједном, што се постиже коришћењем
оператора `+=` за додавање метода на делегат.
